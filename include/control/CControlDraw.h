...
inline LPBYTE GetPngDataFromBitmap(HBITMAP hBitmap, int* size = 0, HDC hSrcDC = 0)
{
    ...
    hr = pGdipCreateBitmapFromScan0(bm.bmWidth, bm.bmHeight, 0, gpPixelFromat32bppARGB, 0, &gpbmp);
    hr = pGdipBitmapLockBits(gpbmp, &gprc, gpImageLockModeRead | gpImageLockModeWrite, gpPixelFromat32bppARGB, &data);
